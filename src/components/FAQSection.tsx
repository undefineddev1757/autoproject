...
6. Передаем вам готовый автомобиль с документами`,
    ...
    {
      question: "Транспортный налог – льготы по регионам",
      answer: `Существуют региональные льготы на транспортный налог для участников СВО — часто освобождение на один автомобиль (или мотоцикл).

Льготы действуют в большинстве регионов России и могут включать:
• Полное освобождение от транспортного налога
• Снижение налоговой ставки
• Льготы распространяются на один автомобиль в собственности

Для получения льготы необходимо обратиться в налоговую службу по месту регистрации автомобиля с соответствующими документами.`,
    },
  ];
